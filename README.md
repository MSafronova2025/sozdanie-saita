...
```
git clone https://gitflic.ru/project/marina27812024/sozdanie-saita-organizacii.git
cd sozdanie-saita-organizacii
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/marina27812024/sozdanie-saita-organizacii.git
git clone
